...
CREATE TABLE Users( UserID VARCHAR(24) NOT NULL DEFAULT ('') PRIMARY KEY,
...
CREATE TABLE Category( CategoryID VARCHAR(24) NOT NULL DEFAULT ('') PRIMARY KEY,
	CategoryName NVARCHAR(128) NOT NULL DEFAULT (''),
	CategorySlug NVARCHAR(254) NOT NULL DEFAULT (''),
...
CREATE TABLE Product( ProductID VARCHAR(24) NOT NULL DEFAULT ('') PRIMARY KEY,
	ProductName NVARCHAR(254) NOT NULL DEFAULT (''),
	ProductPrice NVARCHAR(254) NOT NULL DEFAULT (''),
	ProductDescription  VARCHAR(50) NOT NULL DEFAULT (''),
	ProductSlug INT NOT NULL DEFAULT ((1)),
	ProductActive INT NOT NULL DEFAULT ((0)),
...
CREATE TABLE Image( ImageID VARCHAR(24) NOT NULL DEFAULT ('') PRIMARY KEY,
...
CREATE TABLE Address( AddressID VARCHAR(24) NOT NULL DEFAULT ('') PRIMARY KEY,
	UserID VARCHAR(24) NOT NULL DEFAULT (''),
	AddressName NVARCHAR(128) NOT NULL DEFAULT (''),
	AddressPhone NVARCHAR(12) NOT NULL DEFAULT (''),
	[Default] INT NOT NULL DEFAULT ((1)),
	CONSTRAINT FK_Address_User
	FOREIGN KEY (UserID) REFERENCES Users(UserID))

CREATE TABLE Orders( OrderID VARCHAR(24) NOT NULL DEFAULT ('') PRIMARY KEY,
	UserID VARCHAR(24) NOT NULL DEFAULT (''),
...
CREATE TABLE OrderDetail( OrderDetailID VARCHAR(24) NOT NULL DEFAULT ('') PRIMARY KEY,
	ProductID VARCHAR(24) NOT NULL DEFAULT (''),
...
CREATE TABLE CartItem( CartItemID VARCHAR(24) NOT NULL DEFAULT ('') PRIMARY KEY,
	UserID VARCHAR(24) NOT NULL DEFAULT (''),
	ProductID VARCHAR(24) NOT NULL DEFAULT (''),
